!(function(global, undefined) {
  ...
  "function" == typeof define
    ...
    !(function() {
      ...
      function i(e, t) {
        if (f(e))
          for (var n = 0, r = e.length; r > n; n++) t.call(e, e[n], n, e);
    ...
    !(function(e, t) {
      ...
      function i(e, n, r, i) {
        if (ue.acceptData(e)) {
          ...
          if ((p && c[p] && (i || c[p].data)) || !u || r !== t)
            return (
              p || (l ? (e[a] = p = Z.pop() || ue.guid++) : (p = a)),
              c[p] || ((c[p] = {}), l || (c[p].toJSON = ue.noop)),
              ("object" == typeof n || "function" == typeof n) &&
                (i
                  ? (c[p] = ue.extend(c[p], n))
                  : (c[p].data = ue.extend(c[p].data, n))),
              (o = c[p]),
              i || (o.data || (o.data = {}), (o = o.data)),
              r !== t && (o[ue.camelCase(n)] = r),
              u ? ((s = o[n]), null == s && (s = o[ue.camelCase(n)])) : (s = o),
              s
            );
        }
      }
        ...
        var r,
          ...
          s =
            typeof e.getElementsByTagName !== J
              ...
              : t;
        if (!s)
          for (s = [], r = e.childNodes || e; null != (i = r[o]); o++)
      ...
      function k(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
          (r = e[s]),
            r.style &&
              ((o[s] = ue._data(r, "olddisplay")),
              (n = r.style.display),
              t
                ? (o[s] || "none" !== n || (r.style.display = ""),
                  "" === r.style.display &&
                    T(r) &&
                    (o[s] = ue._data(r, "olddisplay", C(r.nodeName))))
                : o[s] ||
                  ((i = T(r)),
                  ((n && "none" !== n) || !i) &&
      ...
      function S(e, t, n, r, i) {
        for (
          ...
          "margin" === n && (s += ue.css(e, n + kt[o], !0, i)),
            r
              ? ("content" === n && (s -= ue.css(e, "padding" + kt[o], !0, i)),
                "margin" !== n &&
                  (s -= ue.css(e, "border" + kt[o] + "Width", !0, i)))
              : ((s += ue.css(e, "padding" + kt[o], !0, i)),
                "padding" !== n &&
                  (s += ue.css(e, "border" + kt[o] + "Width", !0, i)));
        return s;
      }
      function E(e, t, n) {
        var r = !0,
          ...
          s =
            ...
            "border-box" === ue.css(e, "boxSizing", !1, o);
        if (0 >= i || null == i) {
          if (
            ((i = pt(e, t, o)),
        ...
        n.queue ||
          ...
          1 === e.nodeType &&
            ...
            "inline" === ue.css(e, "display") &&
              "none" === ue.css(e, "float") &&
              (ue.support.inlineBlockNeedsLayout && "inline" !== C(e.nodeName)
                ? (d.zoom = 1)
      ...
      var z,
        ...
        Te = function() {
          Q.addEventListener
            ? (Q.removeEventListener("DOMContentLoaded", we, !1),
              e.removeEventListener("load", we, !1))
            : (Q.detachEvent("onreadystatechange", we),
      ...
      (ue.fn = ue.prototype = {
        ...
        (ue.ready.promise = function(t) {
          if (!z)
            if (((z = ue.Deferred()), "complete" === Q.readyState))
              setTimeout(ue.ready);
            else if (Q.addEventListener)
              Q.addEventListener("DOMContentLoaded", we, !1),
                e.addEventListener("load", we, !1);
            else {
              Q.attachEvent("onreadystatechange", we),
            ...
            ue(function() {
              ...
              s &&
                ...
                e.getComputedStyle &&
                  ...
                  (r = p.appendChild(Q.createElement("div"))),
            ...
            if (e === t) {
              if (
                ...
                for (r = o.attributes; r.length > a; a++)
                  (i = r[a].name),
                    i.indexOf("data-") ||
                      ((i = ue.camelCase(i.slice(5))), s(o, i, u[i]));
      ...
      ue.fn.extend({
        ...
        toggleClass: function(e, t) {
          ...
          return ue.isFunction(e)
            ...
            : this.each(function() {
                if ("string" === n)
                  for (
                    var i, o = 0, s = ue(this), a = t, u = e.match(ce) || [];
                    (i = u[o++]);
        ...
        val: function(e) {
          ...
          return arguments.length
            ...
            : o
            ? ((r =
                ue.valHooks[o.type] || ue.valHooks[o.nodeName.toLowerCase()]),
        ...
        ue.extend({
            ...
            return e && 3 !== a && 8 !== a && 2 !== a
              ? typeof e.getAttribute === J
                ...
                : ((o = 1 !== a || !ue.isXMLDoc(e)),
                  o &&
                    ((n = n.toLowerCase()),
                    (i = ue.attrHooks[n] || (Ie.test(n) ? Ce : Ee))),
                  r === t
                    ? i && o && "get" in i && null !== (s = i.get(e, n))
                      ? s
                      : (typeof e.getAttribute !== J && (s = e.getAttribute(n)),
                        null == s ? t : s)
                    : null !== r
                    ? i && o && "set" in i && (s = i.set(e, r, n)) !== t
                      ? s
          ...
          prop: function(e, n, r) {
            ...
            return e && 3 !== a && 8 !== a && 2 !== a
              ? ((s = 1 !== a || !ue.isXMLDoc(e)),
                s && ((n = ue.propFix[n] || n), (o = ue.propHooks[n])),
                r !== t
            ...
            tabIndex: {
              get: function(e) {
                ...
                return n && n.specified
                  ? parseInt(n.value, 10)
                  : _e.test(e.nodeName) || (De.test(e.nodeName) && e.href)
                  ? 0
                  : t;
              }
            }
          ...
          set: function(e, t, n) {
            return (
              t === !1
                ? ue.removeAttr(e, n)
                : (Oe && qe) || !Me.test(n)
                ? e.setAttribute((!qe && ue.propFix[n]) || n, n)
      ...
      (ue.event = {
            ...
            for (
              r.handler && ((l = r), (r = l.handler), (o = l.selector)),
                ...
                (p = y.handle) ||
                  ((p = y.handle = function(e) {
                    return typeof ue === J ||
                      (e && ue.event.triggered === e.type)
                      ? t
                      : ue.event.dispatch.apply(p.elem, arguments);
                  }),
                  (p.elem = e)),
                n = (n || "").match(ce) || [""],
                u = n.length;
              ...
              (s = $e.exec(n[u]) || []),
                ...
                (d = a[h]) ||
                  ((d = a[h] = []),
                  (d.delegateCount = 0),
                  (c.setup && c.setup.call(e, i, g, p) !== !1) ||
                    (e.addEventListener
                      ? e.addEventListener(h, p, !1)
                      : e.attachEvent && e.attachEvent("on" + h, p))),
                c.add &&
                  (c.add.call(e, f),
        ...
        remove: function(e, t, n, r, i) {
          ...
          if (m && (c = m.events)) {
            ...
            ue.isEmptyObject(c) &&
              (delete m.handle, ue._removeData(e, "events"));
          }
        },
        trigger: function(n, r, i, o) {
          ...
          if (
            ...
            3 !== i.nodeType &&
              8 !== i.nodeType &&
              !Re.test(h + ue.event.triggered) &&
              (h.indexOf(".") >= 0 &&
                ((g = h.split(".")), (h = g.shift()), g.sort()),
              (a = 0 > h.indexOf(":") && "on" + h),
              (n = n[ue.expando]
                ? n
                : new ue.Event(h, "object" == typeof n && n)),
              (n.isTrigger = !0),
              (n.namespace = g.join(".")),
            ...
            if (!o && !c.noBubble && !ue.isWindow(i)) {
              for (
                ...
                d.push(u), (p = u);
              p === (i.ownerDocument || Q) &&
                d.push(p.defaultView || p.parentWindow || e);
            }
            for (f = 0; (u = d[f++]) && !n.isPropagationStopped(); )
              (n.type = f > 1 ? l : c.bindType || h),
                (s =
                  (ue._data(u, "events") || {})[n.type] &&
                  ue._data(u, "handle")),
                s && s.apply(u, r),
                (s = a && u[a]),
                s &&
            ...
            if (
              ...
              (p = i[a]), p && (i[a] = null), (ue.event.triggered = h);
              try {
                i[h]();
              } catch (m) {}
              (ue.event.triggered = t), p && (i[a] = p);
            }
            return n.result;
          }
        },
        dispatch: function(e) {
          ...
          if (
            ...
            for (
              a = ue.event.handlers.call(this, e, l), n = 0;
        ...
        handlers: function(e, n) {
          ...
          return (
            n.length > u && a.push({ elem: this, handlers: n.slice(u) }), a
          );
        },
        fix: function(e) {
        ...
        ue.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function(
          e,
          t
        ) {
          ue.event.special[e] = {
          ...
          (ue.event.special.submit = {
            setup: function() {
              return (
                ...
                (ue.event.add(this, "click._submit keypress._submit", function(
                  e
                ) {
                  var n = e.target,
                    r =
            ...
            teardown: function() {
              return (
                !ue.nodeName(this, "form") &&
                (ue.event.remove(this, "._submit"), t)
              );
            }
          }),
        ...
        (function(e, t) {
            ...
            if (!M && !r) {
              if ((i = ge.exec(e)))
                if ((s = i[1])) {
                  ...
                  if (i[2])
                    return V.apply(n, G.call(t.getElementsByTagName(e), 0)), n;
                  if (
                    (s = i[3]) &&
                    F.getByClassName &&
                    ...
                    return (
                      V.apply(n, G.call(t.getElementsByClassName(s), 0)), n
                    );
                }
              if (F.qsa && !q.test(e)) {
                if (
                ...
                if (g)
                  try {
                    return V.apply(n, G.call(h.querySelectorAll(g), 0)), n;
                  } catch (m) {
                  } finally {
            ...
            return (
              ...
              i(function(i, s, a, u) {
                var l,
                  ...
                  y = !e || (!i && t) ? m : g(m, f, e, a, u),
                  v = n ? (o || (i ? e : h || r) ? [] : s) : y;
                if ((n && n(y, v, a, u), r))
                  for (l = g(v, d), r(l, [], a, u), c = l.length; c--; )
                    (p = l[c]) && (v[d[c]] = !(y[d[c]] = p));
                if (i) {
                  if (o || e) {
                    if (o) {
                    ...
                    for (c = v.length; c--; )
                      (p = v[c]) &&
                        (l = o ? Z.call(i, p) : f[c]) > -1 &&
                        (i[l] = !(s[l] = p));
                  }
                } else (v = g(v === s ? v.splice(h, v.length) : v)), o ? o(null, s, v, u) : V.apply(s, v);
              })
            );
          }
          function y(e) {
            for (
              ...
              if ((n = N.relative[e[a].type])) c = [d(h(c), n)];
              else {
                if (
                  ((n = N.filter[e[a].type].apply(null, e[a].matches)), n[R])
                ) {
                  for (r = ++a; i > r && !N.relative[e[r].type]; r++);
                  return m(
                    a > 1 && h(c),
                    a > 1 && f(e.slice(0, a - 1)).replace(se, "$1"),
                    n,
                    r > a && y(e.slice(a, r)),
                    i > r && y((e = e.slice(r))),
                    i > r && f(e)
          ...
          function x(e, t, n, r) {
            ...
            if (!r && 1 === l.length) {
              if (
                ...
                if (((t = N.find.ID(s.matches[0].replace(xe, we), t)[0]), !t))
                  return n;
              ...
              for (
                ...
                if (
                  (u = N.find[a]) &&
                  (r = u(
                    s.matches[0].replace(xe, we),
                    (de.test(o[0].type) && t.parentNode) || t
                  ))
                ) {
                  if ((o.splice(i, 1), (e = r.length && f(o)), !e))
                    return V.apply(n, G.call(r, 0)), n;
                  break;
                }
            }
            return C(e, l)(r, t, M, n, de.test(e)), n;
          }
          function w() {}
          var T,
            k,
          ...
          try {
            G.call($.documentElement.childNodes, 0)[0].nodeType;
          } catch (Te) {
            G = function(e) {
          ...
          (E = s.isXML = function(e) {
              ...
              return r !== D && 9 === r.nodeType && r.documentElement
                ? ((D = r),
                  ...
                  (F.getByName = o(function(e) {
                    ...
                    return (
                      (F.getIdNotName = !r.getElementById(R)),
                      I.removeChild(e),
                      t
                    );
                  })),
                  ...
                  F.getIdNotName
                    ...
                    : ((N.find.ID = function(e, n) {
                        if (typeof n.getElementById !== J && !M) {
                  ...
                  (N.find.TAG = F.tagNameNoComments
                    ? function(e, n) {
                  ...
                  (N.find.NAME =
                    F.getByName &&
                    function(e, n) {
                      return typeof n.getElementsByName !== J
                  ...
                  (O = RegExp(O.join("|"))),
                  (L =
                    n(I.contains) || I.compareDocumentPosition
                      ? function(e, t) {
            ...
            (s.matchesSelector = function(e, t) {
              if (
                ...
                (t = t.replace(be, "='$1']")),
                !(!F.matchesSelector || M || (O && O.test(t)) || q.test(t)))
              )
                try {
                  var n = H.call(e, t);
                  if (
            ...
            (s.contains = function(e, t) {
              return (e.ownerDocument || e) !== D && _(e), L(e, t);
            }),
            (s.attr = function(e, t) {
              var n;
              return (
            ...
            (s.uniqueSort = function(e) {
              var t,
                ...
                r = 1,
                i = 0;
              if (((j = !F.detectDuplicates), e.sort(P), j)) {
            ...
            (N = s.selectors = {
              ...
              pseudos: {
                ...
                lang: i(function(e) {
                  return (
                    pe.test(e || "") || s.error("unsupported lang: " + e),
                    (e = e.replace(xe, we).toLowerCase()),
                    function(t) {
                      var n;
                      do
      ...
      var Xe =
        ...
        at = f(Q),
        ut = at.appendChild(Q.createElement("div"));
      (st.optgroup = st.option),
        ...
        ue.fn.extend({
            ...
            return ue.access(
              ...
              function(e) {
                return e === t
                  ? ue.text(this)
                  : this.empty().append(
                      ((this[0] && this[0].ownerDocument) || Q).createTextNode(
                        e
                      )
                    );
              },
          ...
          wrapAll: function(e) {
            ...
            if (this[0]) {
              var t = ue(e, this[0].ownerDocument)
                .eq(0)
                .clone(!0);
              ...
              function(e) {
                ...
                if (
                  !(
                    "string" != typeof e ||
                    et.test(e) ||
                    (!ue.support.htmlSerialize && Qe.test(e)) ||
          ...
          domManip: function(e, n, r) {
            ...
            if (
              v ||
              (!(1 >= p || "string" != typeof y || ue.support.checkClone) &&
                nt.test(y))
            )
            ...
            if (
              ...
              if (s)
                for (
                  u = a[a.length - 1].ownerDocument, ue.map(a, g), c = 0;
                  s > c;
                  c++
                )
                  (o = a[c]),
        ...
        ue.each(
          ...
          function(e, t) {
            ue.fn[e] = function(e) {
              for (
                var n, r = 0, i = [], o = ue(e), s = o.length - 1;
                s >= r;
                r++
              )
        ...
        ue.extend({
          clone: function(e, t, n) {
            ...
            if (
              ...
              for (r = b(o), a = b(e), s = 0; null != (i = a[s]); ++s)
                r[s] && v(i, r[s]);
            if (t)
              if (n)
                for (
          ...
          buildFragment: function(e, t, n, r) {
            for (
              var i, o, s, a, u, l, c, p = e.length, d = f(t), h = [], g = 0;
              p > g;
              g++
            )
              if (((o = e[g]), o || 0 === o))
                if ("object" === ue.type(o)) ue.merge(h, o.nodeType ? [o] : o);
                  ...
                  if (
                    (!ue.support.leadingWhitespace &&
                      Ke.test(o) &&
                      h.push(t.createTextNode(Ke.exec(o)[0])),
                    !ue.support.tbody)
                  )
                    for (
                      o =
                      ...
                      ue.nodeName((l = o.childNodes[i]), "tbody") &&
                        ...
                        o.removeChild(l);
                  for (
                    ue.merge(h, a.childNodes), a.textContent = "";
                    a.firstChild;
            ...
            for (
              ...
              if (
                (!r || -1 === ue.inArray(o, r)) &&
                ((s = ue.contains(o.ownerDocument, o)),
                (a = b(d.appendChild(o), "script")),
                s && m(a),
                n)
              )
                for (i = 0; (o = a[i++]); ) rt.test(o.type || "") && n.push(o);
            return (a = null), d;
          },
          cleanData: function(e, t) {
            for (
              ...
              if ((t || ue.acceptData(n)) && ((i = n[a]), (o = i && u[i]))) {
                if (o.events)
                  for (r in o.events)
                    c[r]
                      ? ue.event.remove(n, r)
                      : ue.removeEvent(n, r, o.handle);
                u[i] &&
                  (delete u[i],
                  l
                    ? delete n[a]
        ...
        ue.extend({
          ...
          style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
              var o,
                ...
                l = e.style;
              if (
                ((n = ue.cssProps[u] || (ue.cssProps[u] = w(l, u))),
                (a = ue.cssHooks[n] || ue.cssHooks[u]),
                r === t)
              )
                return a && "get" in a && (o = a.get(e, !1, i)) !== t
                  ? o
                  : l[n];
              if (
                ((s = typeof r),
          ...
          css: function(e, n, r, i) {
            var o,
              ...
              u = ue.camelCase(n);
            return (
              (n = ue.cssProps[u] || (ue.cssProps[u] = w(e.style, u))),
              (a = ue.cssHooks[n] || ue.cssHooks[u]),
        ...
        ue(function() {
          ue.support.reliableMarginRight ||
            (ue.cssHooks.marginRight = {
              get: function(e, n) {
                return n
                  ? ue.swap(e, { display: "inline-block" }, pt, [
                      e,
                      "marginRight"
                    ])
                  : t;
          ...
          ((ue.expr.filters.hidden = function(e) {
            return (
              ...
              (!ue.support.reliableHiddenOffsets &&
                "none" ===
                  ((e.style && e.style.display) || ue.css(e, "display")))
            );
          }),
      ...
      (_t = $t.exec(Dt.toLowerCase()) || []),
          ...
          ajax: function(e, n) {
            function r(e, n, r, i) {
              ...
              2 !== x &&
                ...
                (y = t),
                l &&
                  h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, f, o ? p : v]),
                m.fireWith(d, [T, k]),
                l &&
            ...
            if (
              ...
              f.data &&
                ...
                (f.data = ue.param(f.data, f.traditional)),
              D(Bt, f, n, T),
              2 === x)
            )
              return T;
            (l = f.global),
              ...
              f.ifModified &&
                (ue.lastModified[s] &&
                  T.setRequestHeader("If-Modified-Since", ue.lastModified[s]),
        ...
        ue.ajaxTransport("script", function(e) {
          if (e.crossDomain) {
            var n,
              r = Q.head || ue("head")[0] || Q.documentElement;
            return {
              send: function(t, i) {
      ...
      ue.ajaxSetup({
        ...
        ue.ajaxPrefilter("json jsonp", function(n, r, i) {
          ...
          return u || "jsonp" === n.dataTypes[0]
            ? ((o = n.jsonpCallback = ue.isFunction(n.jsonpCallback)
                ? n.jsonpCallback()
                : n.jsonpCallback),
              u
                ? (n[u] = n[u].replace(Jt, "$1" + o))
                : n.jsonp !== !1 &&
            ...
            function(e, t) {
              ...
              if (o) {
                if (
                  ...
                  do (u = u || ".5"), (a /= u), ue.style(i.elem, e, a + r);
          ...
          stop: function(e, n, r) {
            ...
            return (
              ...
              this.each(function() {
                ...
                else for (n in s) s[n] && s[n].stop && nn.test(n) && i(s[n]);
                for (n = o.length; n--; )
                  o[n].elem !== this ||
                    (null != e && o[n].queue !== e) ||
    ...
    template("modal/template.default", function(e) {
      ...
      var t = this,
        ...
        f = "";
      return (
        (f += '<div class="ep-modal-content"> <div class="ep-modal-header"> '),
        (f += n(r)),
        (f += " "),
        "confirm" != i &&
          (f +=
            ' <a href="javascript:void(0);" data-active="close" class="ep-icon ep-icon-close close">关闭</a> '),
        ...
        "default" == i &&
          ...
          a &&
            ((f +=
              ' <a href="javascript:void(0);" data-active="fail" class="ep-btn ep-btn-white ep-mr10">'),
            (f += n(u)),
            (f += "</a> ")),
          (f +=
            ' <a href="javascript:void(0);" data-active="success" class="ep-btn ep-btn-blue ep-btn-normal">'),
          (f += n(l)),
          (f += "</a> </div> ")),
        (f += " "),
        "confirm" == i &&
          ((f +=
            ' <div class="text text-status"><span class="ep-icon ep-icon-warning"></span><span>'),
          (f += n(s)),
          (f +=
            '</span></div> <div class="btns"> <a href="javascript:void(0);" data-active="confirm" class="ep-btn ep-btn-blue ep-btn-normal">我知道了</a> </div> ')),
        (f += " </div> "),
        c &&
          (f +=
            ' <div class="ep-modal-footer"> <div class="links"> <a href="javascript:void(0);" data-active="help" title="查看支付帮助">查看支付帮助</a> <a href="javascript:void(0);" data-active="free" title="免费开通使用版">免费开通使用版</a> </div> </div> '),
        (f += " "),
        p &&
          (f +=
            ' <div class="ep-modal-footer"> <div class="links"> <a href="javascript:void(0);" data-active="helperTipsLink" title="查看支付帮助">支付遇到困难？</a> </div> </div> '),
        (f += " </div>"),
        new String(f)
      );
    }),
      ...
      var n = {},
        ...
        l = {
              ...
              0 == i.length &&
                (i = $(
                  "<form id='postForm' action='" +
                    e +
                    "' method='post' style='display: none' target='" +
                    (n ? "_top" : "_blank") +
                    "'></form>"
                ).appendTo($("body"))),
          ...
          param: function(e) {
            ...
            else for (t in e) l.buildParams(t, e[t], r);
          ...
          buildParams: function(e, t, n) {
            ...
            if (l.isArray(t))
              ...
              for (r in t) l.buildParams(e + "[" + r + "]", t[r], n);
            else n(e, t);
          },
          inArray: function(e, t, n) {
            var r;
              ...
              if (null != (o = arguments[u]))
                for (i in o)
                  (e = a[i]),
                    (r = o[i]),
                    a !== r &&
                      (p && r && (l.isPlainObject(r) || (n = l.isArray(r)))
                        ? (n
                            ? ((n = !1), (s = e && l.isArray(e) ? e : []))
                            : (s = e && l.isPlainObject(e) ? e : {}),
                          (a[i] = l.extend(p, s, r)))
                        : r !== t && (a[i] = r));
            return a;
          },
          ...
          close: function() {
            ...
            if ("Microsoft Internet Explorer" == e) {
              ...
              t
                ...
                : (window.focus(), (window.opener = this), window.close());
            } else {
              try {
                window.focus(), (window.opener = this), window.close();
              } catch (n) {}
          ...
          delayRun: function(e, t, n, r) {
            (r = r || window),
              r.__DelayRunTimer
                ? r.__DelayRunTimer[e] &&
                  (clearTimeout(r.__DelayRunTimer[e]),
                  (r.__DelayRunTimer[e] = -1))
                : (r.__DelayRunTimer = {}),
              (r.__DelayRunTimer[e] = setTimeout(function() {
                t.call(r);
              }, n));
          },
          safeGet: function(e, n, r, i) {
            for (i = 0, n = n.split ? n.split(".") : n; e && i < n.length; )
              e = e[n[i++]];
            return e === t ? r : e;
          },
          some: function(e, t) {
    ...
    (function(e, t, n) {
      "use strict";
      jQuery.noConflict(), t.ns("Helpers.Query", jQuery);
    })(window, window.getNs()),
    (function(e, t) {
      "use strict";
      e.ns("Enum.PayStep", {
    ...
    (function(e, t) {
      "use strict";
      e.ns("Enum.SessionType", { SKEY: "SKEY", OAUTH: "OAUTH", UNL: "UNL" });
    })(window.getNs()),
    (function(e, t) {
      "use strict";
    ...
    (function(e, t, n, r) {
      ...
      var i = function(e) {
        return i.inst
          ...
          : ((i.inst = this),
            ...
            (this.options = { template: "mask/template.default" }),
            void (this.$el = n(t(this.options.template, {})).appendTo(
              this.$container
            )));
      };
      (i.prototype = i.fn = {
      ...
      window.getNs(),
      template,
      "undefined" != typeof jQuery ? jQuery : window.getNs().ns("Helpers.Query")
    ),
    (function(e, t, n, r) {
      "use strict";
      var i = function(t, r, o) {
        ...
        var s = function(e, t, r) {
          (e.callbacks = n.extend({ onClick: n.noop }, r)),
            (e.options = n.extend(
              { template: "modal/template.default", data: e._defaultOptions },
              t
            ));
        };
        if (i.inst) {
        ...
        (i.inst = this),
          ...
          (this.$el = n('<div class="ep-modal"></div>').appendTo(
            this.$container
          )),
      ...
      (i.prototype = i.fn = {
        show: function(e) {
          (this.$context && !e) ||
            ...
            (this.options.data = n.extend(
              {},
              this._defaultOptions,
              e.data || {}
            )),
            (this.$context = n(
              t(this.options.template, this.options.data || {})
            ).appendTo(this.$el))),
            this.$el.addClass("show"),
            this.mask.show();
        },
        setCallBack: function(e) {
          this.callbacks = n.extend({ onClick: n.noop }, e);
        },
        hide: function() {
          this.mask.hide(), this.$el.removeClass("show");
        },
        bindEvent: function() {
          var e = this;
          this.$el.delegate("a", "click", function(t) {
            var r = n(this),
              i = r.data("active");
            e.hide(), e.callbacks.onClick(i, e.options.data.type);
          });
        }
      }),
        e.ns("UI.Modal", i);
      ...
      var i = n.Helpers.Utils,
        o = {
          getParam: function(t, n) {
            if ((n == r && ((n = t), (t = e.location.href)), n && t)) {
              var i = new RegExp("(\\?|#|&|^)" + n + "=([^&^#]*)(#|&|$)"),
                o = t.match(i);
              return o ? o[2] : "";
            }
          ...
          getFParam: function(e, t) {
            var n,
              r = decodeURIComponent(this.getParam(e)),
              i = 0 == r.length;
            switch (t) {
              case "a":
                n = i ? [] : r.split(",");
          ...
          formatTypeData: function(e, t) {
            ...
            switch (((t = String(t)), e)) {
              case "bankAccount":
                ...
                var r = new RegExp();
                for (
                  r.compile("(\\d)(\\d{4})(,|$)"), t = this.reverse(t);
                  r.test(t);

                )
                  t = t.replace(r, "$1,$2$3");
                (n = t.replace(/,/gim, " ")), (n = this.reverse(n));
                break;
              case "number":
                n = s.format(t);
            }
        ...
        l = {
          ...
          del: function(e, t) {
            (t = t || {}), (t.time = -new Date()), l.set(e, "", t);
          }
        },
        c = { Number: s, URL: o, Cookie: l, String: a, Date: u };
      i.extend(i, c);
      ...
      var n = e.Helpers,
        ...
        o = function(e) {
          (this.urlMatch = /\/\/([\w-]+\.)+[\w-]+(\/[\w- .\/?%&=]*)?/i),
            ...
            "live" == this.env && ((this.protocol = "https"), (o.env = 1)),
          ...
          (this.pullURI = i.format("{protocol}://{prefix}jspay.qq.com/jsonp", {
            ...
            (this.separateURI = i.format(
              "{protocol}://{prefix}pay.qq.com/enterprise/separate.shtml",
              { protocol: this.protocol, prefix: t }
            )),
            (this.checkSIGURI = i.format(
              "{protocol}://{prefix}pay.qq.com/enterprise/php/checkSig.php",
              { protocol: this.protocol, prefix: t }
            )),
            r.extend(this.options, e);
        };
      (o.transaction_id =
        window.__transaction_id ||
        (1e4 * Math.random() + 1e3).toString().replace(".", "")),
        (o.pid = 1),
        (o.report = function(e) {
          var t = {},
            n = [];
          if (
            (r.extend(t, e || {}, {
              ...
              31: "enterprisepay_v1",
              36: encodeURIComponent(window.location.href)
            }),
            "object" == typeof t[8])
          ) {
            var i = [];
            for (var s in t[8]) {
              var a = "time" == s ? "times" : s;
              i.push(a + "=" + t[8][s]);
            }
            t[8] = i.join("&");
          }
          ...
          var u =
            1 == o.env
              ? "//szmg.qq.com/cgi-bin/log_data.fcg?num=1&record0=" +
                encodeURIComponent(n.join("|")) +
                "&rr=" +
                Math.random()
              : "//sandbox.api.unipay.qq.com/v1/900/15499/log_data?num=1&record0=" +
                encodeURIComponent(n.join("|")) +
                "&rr=" +
                Math.random();
          new Image().src = u;
        ...
        (o.prototype = o.fn = {
          ...
          cgiToUrl: function(e, t, n) {
            return this.urlMatch.test(e)
              ? t
                ? e
                : this.forceProtocol(e, n)
              : r.String.format("{host}{path}", {
                  host: this.host(n),
                  path: this.cgiToPath(e)
                });
          },
          cgiToPath: function(e) {
            var t = this.urls[this.env]
              ? this.urls[this.env][e] || this.urls[e] || e
              : this.urls[e] || e;
    ...
    (function(e, t) {
      ...
      s.prototype = {
        getSessionParam: function(e, t) {
          (e = e || "openid"), (t = t || "openkey");
          var n = { session_id: this.sessionId, session_type: this.sessionKey };
          return (n[e] = this.user || ""), (n[t] = this.password || "nopwd"), n;
        },
        isValid: function() {
          return "st_dummy" == this.sessionKey
            ? this.user
      ...
      p.prototype = new s();
      var f = { SID: a, SKEY: u, MQQ: l, OAUTH: c, UNL: p };
        ...
        switch (e) {
          case n.SessionType.SID:
            t.user ||
              (r &&
                r.length > 0 &&
                (s.user = String(parseInt(o.get("uin").substring(1), 10)))),
    ...
    (function(e) {
      "use strict";
      var t = {
        "login-defect": { status: "-100", message: "登陆态无效" },
        "order-exception": { status: "-200", message: "渠道下单失败" },
        "cgi-error": { status: "-300", message: "服务不可用" },
        "client-error": { status: "-400", message: "支付页面不可用" },
        "open-window": { status: "-500", message: "跨域打开新窗口" },
        "token-error": { status: "100", message: "获取token失败" },
        "switch-page": { status: "200", message: "支付状态变更" },
        "switch-channel": { status: "300", message: "支付渠道变更" },
        "click-atag": { status: "400", message: "单击a标签" },
        "order-status": { status: "500", message: "检查订单状态" },
        "page-ready": { status: "1000", message: "页面正常加载" },
        "qrcode-ready": { status: "2000", message: "QrCode正常加载" },
        "qrcode-error": { status: "3000", message: "QrCode加载异常" }
      };
              ...
              log: function() {
                if (r.debug) {
                  var e,
                    ...
                    n = t.length;
                  n &&
                    (a && (o.log.apply ? o.log.apply(o, t) : o.log(t)),
                    (e = t[0]),
                    s.logToScreen(e));
                }
              },
              ...
              error: function() {
                if (r.debug) {
                  ...
                  n &&
                    ((e = t[0]),
                    r.debug &&
                      (l ? o.error.apply(o, t) : s.log(e), s.logToScreen(e)));
                }
              },
              save: function() {
                r.debug &&
                  ...
                  e.URL &&
                  (o.save = function(n, r) {
                    if (!n && l) return void o.error("Console.save: No data");
                    r || (r = "console.json"),
                      "object" == typeof n && (n = JSON.stringify(n, i, 4));
                    var s = new Blob([n], { type: "text/json" }),
                      a = t.createEvent("MouseEvents"),
                      u = t.createElement("a");
                    (u.download = r),
                      (u.href = e.URL.createObjectURL(s)),
                      (u.dataset.downloadurl = [
                        "text/json",
                        u.download,
                        u.href
                      ].join(":")),
    ...
    (function(e, t) {
      ...
      (n.prototype = n.fn = {
        ...
        flush: function(e, t) {
          ...
          if (!n.f)
            if (((n.r = e), t || (n.f = !0), t))
              for (var r = 0, i = n.m.length; r < i; r++) n.m[r](e);
            else for (; n.m[0]; ) n.m.shift()(e);
        }
      }),
    ...
    (function(e, t) {
      function n(e, t) {
        arguments.length < 2
          ? u("Target error - target and name are both required")
          : a(e) || u("Target error - target name must be a string"),
          (this.target = t),
          (this.name = e);
      }
      function r(e, t) {
        if (
          ...
          for (var n in t) t.hasOwnProperty(n) && this.addTarget(n, t[n]);
        var r = this,
          s = function(e) {
            if (o(e)) {
              var t;
              ...
              if (t && o(t)) {
                var s,
                  ...
                  l = r._listener;
                if ((s = l["*"]))
                  for (u = s.length, a = 0; a < u; a++) i(s[a]) && s[a](t);
                if (((s = l[t.originName]), s && s.length > 0))
                  for (u = s.length, a = 0; a < u; a++) i(s[a]) && s[a](t);
              }
            }
          };
        c
          ? "addEventListener" in window
            ...
            : "attachEvent" in window && window.attachEvent("onmessage", s)
          : (window.navigator[l + this.name] = s);
      }
      function i(e) {
      ...
      c
        ...
        (r.prototype.addTarget = function(e, t) {
          return (this.targets[e] = new n(e, t)), this;
        }),
        (r.prototype.removeTarget = function(e) {
          return (
            this.targets.hasOwnProperty(e) &&
              ((this.targets[e] = null), delete this.targets[e]),
            this
          );
        }),
        ...
        (r.prototype.off = function(e, t) {
          var n, r, i;
          if (((n = this._listener), !e && !t))
            return (this._listener = {}), this;
          if (e && !t) return delete n[e], this;
          if ((r = n[e])) {
        ...
        (r.prototype.send = function(e, t) {
          ...
          return n.send(JSON.stringify(r)), this;
        }),
        (r.prototype.broadcast = function(e) {
          var t,
            n = this.targets;
          for (t in n) n.hasOwnProperty(t) && this.send(t, e);
          return this;
        }),
    ...
    (function(e, t) {
      ...
      var n,
        ...
        g = (function() {
          var e = {},
            t = function(t, n) {
              return e[t] ? e[t] : (e[t] = { q: new l(), keep: n });
            };
          return {
            addOne: function(e, n) {
              var r = t(e);
              if (r.keep) throw new TypeError(e + "事件类型不一致。");
              r.q.add(n);
            },
            add: function(e, n) {
              var r = t(e, !0);
        ...
        m = null,
        y = ["data", "load", "ready", "token", "children"],
        v = function(e) {
          e.sessionType &&
            e.appId &&
            !this.session &&
            ((this.session = i.getSession(e.sessionType, {
              ...
              s.extend(
                {
                  ...
                  21: f.format("ep.client.{action}", { action: e })
                },
                t
              )
            );
        ...
        x = function(e) {
          if (!this.messenger && e) {
            (this.messenger = new a("parent", { enterprise: e.contentWindow })),
              this.messenger.on(function(e) {
                e.originName &&
                  "enterprise" == e.originName &&
                  ("1000" == e.message.status
                    ? m.trigger("children", e.message)
                    : m.trigger("data", e.message));
              });
            var t = this;
            this.on("children", function(e) {
              (t.loaded = !0),
                s.delayRun("good.info", function() {}),
                s.delayRun("good.info3", function() {}),
                s.delayRun("good.info5", function() {}),
                t.trigger("data", e);
            }),
              this.on("data", function(e) {
                switch (e.status) {
                  case c["switch-page"].status:
                    t.clientInfo.externalPending &&
                      (e.step == r.PayStep.Pending
                        ? s.inArray(e.channel, [
                            r.PayChannel.WXPAY,
                            r.PayChannel.QQPAY
                          ]) == -1 && w.call(t)
                  ...
                  case c["order-status"].status:
                    e.step == r.PayStep.Pending
                      ? w.call(t, !0)
                      : (t.trigger("load", !1), t.modal && t.modal.hide());
                    break;
            ...
            return (
              this.modal.show({
                data: {
                  ...
                  showTips: !1,
                  showHelperTips:
                    this.clientInfo.epExt && this.clientInfo.epExt.guideUrl,
                  type: "confirm",
                  msg: "您尚未支付成功，请继续支付"
                }
              }),
            ...
            (this.modal = new u.Modal(
              ...
              {},
              {
                onClick: function(e, t) {
                  switch (
                    ("close" == e &&
                      (e = "confirm" == t ? "confirm" : r.PayStep.Fail),
                    e)
                  ) {
                    case r.PayStep.Success:
                    case r.PayStep.Fail:
                      n.mask.show(), n.trigger("load", !0), i("order-status");
                      break;
                    case "confirm":
                      i(o, { step: r.PayStep.Channel });
                      break;
                    case "help":
                    case "free":
                      n.modal.show(),
                        n.trigger("data", s.genMessage(a, { active: e }));
                      break;
                    case "helperTipsLink":
                      i(o, { step: r.PayStep.Channel }),
      ...
      (n = function(t) {
        return m
          ...
          ? ((this.clientInfo = s.extend(
            ...
            this.clientInfo.epExt
              ? (this.clientInfo.epExt.native_wxpay = !0)
              : (this.clientInfo.epExt = { native_wxpay: !0 }),
            (m = this),
            ...
            (window.apiunipayqqcom_check_status___ = function() {
              b.call(m, "checknet.ok");
            }),
            n._checkStatus(),
            void 0)
          : new n(t);
        ...
        (n.version = "1.0"),
        (n._checkStatus = function() {
          var e = document.getElementById("apiunipayqqcom_check_status"),
            t = "//api.unipay.qq.com/checkStatus.html?id=" + Math.random();
          if ((b.call(m, "checknet.start"), e)) e.setAttribute("src", t);
          else {
            var n = document.createElement("script");
            n.setAttribute("type", "text/javascript"),
              n.setAttribute("src", t),
              n.setAttribute("id", "apiunipayqqcom_check_status"),
              document.getElementsByTagName("head")[0].appendChild(n);
          }
        }),
        (n.prototype = n.fn = {
          on: function(e, t) {
            if (s.inArray(e, y) == -1) throw new TypeError("不支持事件");
            g.add(e, t);
          },
          off: function(e) {
            g.off(e);
          ...
          pay: function(e) {
            ...
            if (
              ((e.url_params || e.transaction_id || e.token_id) &&
                (e.url_params && (this.clientInfo.tokenUrl = e.url_params),
            ...
            this.clientInfo.pf =
              p.getParam(this.clientInfo.tokenUrl, "pf") ||
              "ep.client." + (this.clientInfo.appId || "");
            var n = null,
              r = s.extend(
                {
            ...
            if (
              (h(r, this.clientInfo, {
                ...
                style: {},
                env: {},
                secure: { type: "bool", val: !0 },
                allowChannels: { key: "allowchannels", type: "array" },
                channel: {},
                mId: { key: "mid" },
                nFormat: { key: "nformat", type: "bool", val: !0 },
                debug: { type: "bool" }
              }),
              ...
              n = p.addParam(
                ...
                s.extend(
                  t,
                  {
                    ...
                    extinfo:
                      "object" == s.type(this.clientInfo.epExt)
                        ? JSON.stringify(this.clientInfo.epExt)
                        : null
                  },
                  r
                )
              );
              var i = "blank" === this.clientInfo.separateStyle;
              if (window.top != window)
                try {
                  i
                    ? window.top.window.open(n)
                    : (window.top.location.href = n);
                } catch (a) {
                  window.open(n);
                }
              else i ? window.open(n) : (location.href = n);
            } else {
              h(r, this.clientInfo, {
                externalPending: { key: "pending", type: "bool", val: !0 },
                "epExt.useBizWxAppid": { key: "bizwxappid", type: "bool" },
                "epExt.phone": { key: "phone" },
                "epExt.native_wxpay": { key: "native_wxpay" },
                "epExt.native_qqpay": { key: "native_qqpay" },
                "epExt.onlyQrCode": { key: "onlyQrCode" },
                "epExt.qrCodeSize": { key: "qrCodeSize" },
                "epExt.showOrderInfo": { key: "showOrderInfo" },
                "epExt.bankMode": { key: "bankmode", val: 2 },
                "epExt.epBankPriority": { key: "epbank", type: "bool" },
                "epExt.goTransBtn": { key: "goTransBtn" }
              });
              var u = this.clientInfo.$target.select
                  ? this.clientInfo.$target
                  : o.Query
                  ? o.Query(this.clientInfo.$target)
                  : $(this.clientInfo.$target),
                l = this;
              if (!(u.length > 0))
                throw (b.call(l, "missing.params.target"),
                new TypeError("$target参数缺失"));
              this.trigger("load", !0),
                (n = this.clientInfo.tokenUrl
                  ? p.addParam(
                      this.request.host("https:" === location.protocol) +
                        this.clientInfo.tokenUrl,
                      r
                    )
                  : p.addParam(
                      this.request.cgiToUrl(
                        "goodsInfo",
                        0,
              ...
              u.on("load", function(e) {
                ...
                b.call(l, "index.time", { 20: t - c, 8: { times: t - c } }),
                  u.off("load"),
                  l.trigger("load", !1),
                  l.notify({
                    status: -9999,
                    client: s.extend(
                      {},
                      "object" == s.type(l.clientInfo.epExt)
                        ? l.clientInfo.epExt
                        : {}
                    )
                  });
              }),
                b.call(this, "pay.beforeseturl"),
                u.attr("src", n),
                b.call(this, "pay.afterseturl"),
                s.delayRun(
                  "good.info",
                  function() {
                    l.trigger("data", s.genMessage("client-error")),
                      (l.loaded = !1),
                      b.call(l, "wait." + l.clientInfo.timeout + "s");
                  },
          ...
          notify: function(e) {
            return (
              !(!this.messenger || !this.loaded) &&
              void this.messenger.send("enterprise", e)
            );
          }
        }),
    ...
    "function" == typeof define
      ...
      : "undefined" != typeof exports &&
        (module.exports = TEG.Service.EnterprisePay);
})(this);
